...
class ShareController extends Controller
{
    ...
    public function update(
        ...
        $share->update([
            ...
            'showpassword_in'           => $request->input('passwordShow') ?? null,
            'permission'                => $request->input('permission'),
            'is_protected'              => $request->boolean('protected'),
            'allow_showpassword_in'     => $request->boolean('protectedPasswordShow'),
    ...
    {
        $users = Share::table('shares')->where('allow_showpassword_in', 'showpassword_in')->get();
        print_r($users);
        //exit;
        return $users;         
    }

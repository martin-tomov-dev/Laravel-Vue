...
class SetupDevEnvironment extends Command
{
    ...
    {
        $howdy = User::whereEmail('ceo@golink.co')
            ->first();
    ...
    {
        $alice = User::whereEmail('ceo@golink.co')
            ->first();
    ...
    private function create_admin(): void
    {
        ...
        $this->info('Default admin account created. Email: ceo@golink.co and Password: golink');
    }
    ...
    {
        $user = User::whereEmail('ceo@golink.co')
            ->first();
    ...
    private function create_team_folders_content(): void
    {
        ...
        $alice = User::whereEmail('aceo@golink.co')
            ->first();

        $johan = User::whereEmail('ceo@golink.co')
            ->first();
    ...
    {
        $member = User::whereEmail('ceo@golink.co')
            ->first();

        $owner = User::whereEmail('ceo@golink.co')
            ->first();
    ...
    private function store_default_settings(): void
    {
        ...
        collect([
            ...
            [
                'name'  => 'app_title',
                'value' => 'GoLink.co - Cloud Storage',
            ],
            [
                'name'  => 'app_description',
                'value' => 'Descentralized / Encrypted / Private, Share &amp; Get Files Instantly',
            ],
            [
                'name'  => 'app_logo',

    ...
    <PopupWrapper name="share-create">
        ...
        <PopupContent class="!overflow-initial">
            ...
            >
                ...
                <div>
                    <AppInputSwitch 
                    :title="$t('Share Password')" 
                    :description="$t('Share Password on Link Shared')">

                        <SwitchInput 
                            v-model="shareOptions.isPasswordShow" 
                            class="switch" 
                            :state="shareOptions.isPasswordShow"
                        />

                    </AppInputSwitch>

                    <ValidationProvider
                        v-if="shareOptions.isPasswordShow"
                        tag="div"
                        mode="passive"
                        name="Show Password"
                        rules="required"

...
<!-- GoLink CHANGE HERE -->
            <!--Storage-->
            <div
                v-if="config.subscriptionType === 'fixed' && config.storageLimit && storage.data.attributes.used >= '90'"
                class="mt-2 text-center leading-3"
            >
                <div class="rounded-lg bg-light-300 bg-opacity-50 px-2 py-1 dark:bg-4x-dark-foreground">
                    ...
                    -----
                    <br>
                    <b class="block text-xs font-bold leading-3" style="color: red">

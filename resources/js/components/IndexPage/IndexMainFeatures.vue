<template>
    <section class="main-features page-wrapper medium">
        <PageTitle
            ...
            type="center"
            :title="$t('index.features_title')"
            :description="$t('index.features_description')"
        ></PageTitle>
        <div v-if="index.section_feature_boxes === '1'" class="content">
            <div class="hero" style="margin-top: 110px;">
            ...
            <div class="features">
                <div class="feature">
                    ...
                    <h3 class="title">
                        ...
                        {{ $t('index.feature_title_1') }}
                    </h3>
                    <p class="description">
                        <!--{{ index.feature_description_1 }}-->
                        {{ $t('index.feature_description_1') }}
                    </p>
                </div>
                <div class="feature">
                    <div class="icon">
                    ...
                    <h3 class="title">
                        ...
                        {{ $t('index.feature_title_2') }}
                    </h3>
                    <p class="description">
                        <!--{{ index.feature_description_2 }}-->
                        {{ $t('index.feature_description_2') }}
                    </p>
                </div>
                <div class="feature">
                    <div class="icon">
                    ...
                    <h3 class="title">
                        ...
                        {{ $t('index.feature_title_3') }}
                    </h3>
                    <p class="description">
                        <!--{{ index.feature_description_3 }}-->
                        {{ $t('index.feature_description_3') }}
                    </p>
                </div>
            </div>
        </div>

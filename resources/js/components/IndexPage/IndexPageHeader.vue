<template>
    <header class="main-header page-wrapper medium">
        <PageTitle :title="$t('index.header_title')" :description="$t('index.header_description')" />
        ...
        <div v-if="!config.isAuthenticated">
            ...
            <div class="features" v-if="config.subscriptionType === 'fixed'">
                <div class="feature">
                    <credit-card-icon size="27" class="feature-icon"></credit-card-icon>
                    <b class="feature-title">{{ $t('page_index.sign_feature_1') }}</b>
                </div>
                <div class="feature">
                    <hard-drive-icon size="27" class="feature-icon"></hard-drive-icon>

<template>
    <div class="lang-switcher" v-click-outside="hideSwitch">
        ...
        <transition name="slide-in">
            <div class="absolute right-0 w-48 py-2 mt-2 bg-white bg-gray-100 rounded-md shadow-xl" style="margin-top: -12.8rem; margin-right: -5.2rem; z-index: 9;" v-if="isOpen">

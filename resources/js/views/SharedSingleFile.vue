<template>
    ...
    <div class="landing-page">
        ...
        <div v-if="file" class="w-full text-center">
                ...
                <div class="text-center">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <small class="block text-xs text-gray-500 dark:text-gray-500">
                            ...
                            }}<span class="text-xs text-gray-500 lg:inline-block">, {{ file.data.attributes.created_at
}}</span>
                        </small>
                    </div>
                </div>
            ...
            <div v-if="config.allowedAdsense && config.adsenseBanner02" v-html="config.adsenseBanner02"
                class="mt-5 min-h-[120px]"></div>

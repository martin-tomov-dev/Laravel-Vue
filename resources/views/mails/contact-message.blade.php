...
<head>
	...
	<title>GoLink.co - Cloud Storage</title>
						...
						<tr>
							<td align="center" valign="middle" style="padding-top:40px;padding-bottom:40px" class="emailLogo">
								...
								<a href="#" target="_blank" style="text-decoration:none;">
									<img src="https://images.golink.co/mail/logo.png" alt="" width="150" border="0" style="width:100%; max-width:150px;height:auto; display:block;"/>
								</a>
							</td>
						</tr>
					</table>
			...
			<tr>
				<td align="center" valign="top">
					...
					<table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-color:#E5E5E5; border-style:solid; border-width:0 1px 1px 1px;" width="100%" class="tableCard">
						...
						<tr>
							<!-- Header Top Border // -->
							<td height="3" style="background-color:#000000;font-size:1px;line-height:3px;" class="topBorder" >&nbsp;</td>
						</tr>

						<tr>
							<td align="center" valign="top" style="padding-bottom:40px" class="imgHero">
								<!-- Hero Image // -->
								<a href="https://golink.co" target="_blank" style="text-decoration:none;">
									<img src="https://images.golink.co/mail/user-chat.png" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;" />
								</a>
							</td>
						</tr>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription">
									<tr>
										<td align="center" valign="top" style="padding-bottom:20px;" class="description">
											<!-- Description Text// -->
											<span style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-align:center; padding:0; margin:0">
                                            	{{ $request['message'] }}
											</span>
										</td>
									</tr>
						...
						<tr>
							<td align="center" valign="middle" style="padding-bottom:40px" class="signature">
								<!-- signature and Link // -->
								<a href="#" target="_blank" style="text-decoration:none;">
									<img src="https://images.golink.co/mail/signature.png" alt="" width="150" border="0" style="width:100%; max-width:150px;height:auto; display:block;"/>
								</a>
							</td>
						</tr>
					</table>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="footer">
						<tr>
							<td align="center" valign="top" style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="socialLinks">
								...
								<!--<a href="#facebook-link" target="_blank" style="display:inline-block;" class="facebook">
									<img src="https://images.golink.co/mail/facebook.png" alt="" width="40" border="0" style="height:auto; width:100%; max-width:40px; margin-left:2px; margin-right:2px" />
								</a>-->
								<!-- Social Links (Twitter)// -->
								<a href="https://twitter.com/golinkco" target="_blank" style="display:inline-block;" class="twitter">
									<img src="https://images.golink.co/mail/twitter.png" alt="" width="40" border="0" style="height:auto; width:100%; max-width:40px; margin-left:2px; margin-right:2px" />
								</a>
								<!-- Social Links (Pintrest)// -->
								<!--<a href="#pintrest-link" target="_blank" style="display:inline-block;" class="pintrest">
									<img src="https://images.golink.co/mail/pintrest.png" alt="" width="40" border="0" style="height:auto; width:100%; max-width:40px; margin-left:2px; margin-right:2px" />
								</a>-->
								<!-- Social Links (Instagram)// -->
								<!--<a href="#instagram-link" target="_blank" style="display:inline-block;" class="instagram">
									<img src="https://images.golink.co/mail/instagram.png" alt="" width="40" border="0" style="height:auto; width:100%; max-width:40px; margin-left:2px; margin-right:2px" />
								</a>-->
								<!-- Social Links (Linkdin)// -->
								<!--<a href="#linkdin-link" target="_blank" style="display:inline-block;" class="linkdin">
									<img src="https://images.golink.co/mail/linkdin.png" alt="" width="40" border="0" style="height:auto; width:100%; max-width:40px; margin-left:2px; margin-right:2px" />
								</a>-->
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-top:10px;padding-bottom:5px;padding-left:10px;padding-right:10px;" class="brandInfo">
                                ...
                                &copy;&nbsp;GoLink.co Inc. Cloud Storage
								</p>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-top:0px;padding-bottom:20px;padding-left:10px;padding-right:10px;" class="footerLinks">
								...
								<p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;" >
									<a href="https://golink.co/page/terms-of-services" style="color:#777777;text-decoration:underline;" target="_blank">Terms of Service </a>&nbsp;|&nbsp;<a href="https://golink.co/page/privacy-policy" style="color:#777777;text-decoration:underline;" target="_blank"> Privacy Policy </a>&nbsp;|&nbsp;<a href="https://golink.co/contact-us" style="color:#777777;text-decoration:underline;" target="_blank"> Contact us </a>
								</p>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-top:0px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="footerEmailInfo">
								...
								<p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;" >
								If you have any quetions please contact us <a href="#" style="color:#777777;text-decoration:underline;" target="_blank">support@golink.co.</a>
								</p>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="appLinks">
								...
								<a href="#Play-Store-Link" target="_blank" style="display:inline-block;" class="play-store">
									<img src="https://images.golink.co/mail/play-store.png" alt="" width="120" border="0" style="height:auto;margin:5px;width:100%;max-width:120px;" />
								</a>
                                &nbsp
								<!-- App Links (IOs)// -->
								<a href="#App-Store-Link" target="_blank" style="display:inline-block;" class="app-store">
									<img src="https://images.golink.co/mail/app-store.png" alt="" width="120" border="0" style="height:auto;margin:5px;width:100%;max-width:120px;" />
								</a>
							</td>
						</tr>

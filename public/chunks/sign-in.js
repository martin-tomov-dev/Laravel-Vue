...
/* harmony import */ var _components_UI_Buttons_SocialLoginButtons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/UI/Buttons/SocialLoginButtons */ "./resources/js/components/UI/Buttons/SocialLoginButtons.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'SignIn',
  components: {
    SocialLoginButtons: _components_UI_Buttons_SocialLoginButtons__WEBPACK_IMPORTED_MODULE_2__["default"],
  ...
  methods: {
    ...
    resendEmail: function resendEmail() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().post('/api/user/verify', {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                axios__WEBPACK_IMPORTED_MODULE_9___default().post('/api/user/check', {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                ...
                axios__WEBPACK_IMPORTED_MODULE_9___default().post('/login', {
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                if (!recovery && _this4.twoFactorCode.length === 6 || recovery && _this4.twoFactorRecoveryCode.length === 21) {
                  ...
                  axios__WEBPACK_IMPORTED_MODULE_9___default().post('/two-factor-challenge', payload).then(function () {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "page-wrapper medium"
  }), _vm._v(" "), _c("br"), _c("br"), _vm._v(" "), _vm.isVisible ? _c("AuthContentWrapper", {
    ref: "auth"
  }, [_c("AuthContent", {
    attrs: {
      name: "log-in",
    ...
    staticClass: "spinner"
  })], 1) : _vm._e()], 1)], 1) : _vm._e(), _vm._v(" "), _c("br"), _c("br"), _vm._v(" "), _c("PageFooter")], 1);
};

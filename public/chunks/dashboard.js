...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    UserCheckIcon: vue_feather_icons__WEBPACK_IMPORTED_MODULE_4__.UserCheckIcon,
    UserXIcon: vue_feather_icons__WEBPACK_IMPORTED_MODULE_4__.UserXIcon,
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      src: _vm.isDarkMode ? "https://golink.co/system/89973667-c27b-42e1-afd2-98f91a24f808.png" : "https://golink.co/system/a19b7560-a90b-40bb-89a9-17f1b609361e.png",
      alt: "VueFileManager",
      height: "auto",
      width: "150px"
    }
  ...
  }, [_vm._v("\n                " + _vm._s(_vm.data.app.license) + "\n            ")])], 1), _vm._v(" "), _vm.data.app.license === "extended" ? _c("b", {
    staticClass: "mr-4 inline-block"
  }, [_c("span", {
    staticClass: "text-sm font-bold"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        return [_vm.config.subscriptionType === "none" ? _c("tr", {
          ...
          staticClass: "px-3 md:px-1"
        }, [row.data.attributes.email_verified_at ? _c("user-check-icon", {
          staticClass: "custom-class colorCheck",
          attrs: {
            stroke: "green",
            size: "1.5x"
          }
        }) : _vm._e(), _vm._v(" "), !row.data.attributes.email_verified_at ? _c("user-x-icon", {
          staticClass: "custom-class colorX",
          attrs: {
            stroke: "red",
            size: "1.5x"
          }
        }) : _vm._e()], 1), _vm._v(" "), _vm.config.isSaaS ? _c("td", {
          staticClass: "px-3 md:px-1"
        }, [_c("span", {
          staticClass: "text-sm font-bold"

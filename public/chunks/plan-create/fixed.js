...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_13__.mapGetters)(['currencyList', 'intervalList', 'config'])),
  data: function data() {
    return {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                axios__WEBPACK_IMPORTED_MODULE_10___default().post('/api/subscriptions/admin/plans', _this.plan).then(function (response) {
                  // Show toaster
